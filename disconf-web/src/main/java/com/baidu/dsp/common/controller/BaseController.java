...
public class BaseController implements ApplicationContextAware {
    ...
    protected  JsonObjectBase buildSuccess(CodeMsg codeMsg) {
        return JsonObjectUtils.buildObjectSuccess(codeMsg);
    }
     ...
     * @return
     */
    protected <T> JsonObjectBase buildFail(String key,T value){
        return JsonObjectUtils.buildObjectFail(key,value);
    }
