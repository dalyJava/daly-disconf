...
public class JsonObjectUtils {
     ...
     * @return
     */
    public static JsonObjectBase buildObjectSuccess(CodeMsg codeMsg) {

        JsonObject json = new JsonObject();

        json.addData("codeMsg",codeMsg);
    ...
    public static <T> JsonObjectBase buildObjectFail(String key,T value) {
        JsonObject json = new JsonObject();
