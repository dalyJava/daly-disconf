...
public class ReloadingPropertyPlaceholderConfigurer extends DefaultPropertyPlaceholderConfigurer implements
    ...
    private static final String SYSTEM_PROPERTIES_MODE_FIELD = "systemPropertiesMode";
    ...
    protected String parseStringValue(String strVal, final Properties props, Set visitedPlaceholders)
        ...
        while (startIndex != -1) {
            int endIndex = buf.toString()
                .indexOf(this.placeholderSuffix, startIndex + this.placeholderPrefix.length());
            if (endIndex != -1) {
        ...
        PropertyPlaceholderHelper helper = new PropertyPlaceholderHelper(placeholderPrefix,
            placeholderSuffix,
        ...
        PlaceholderResolver resolver = new PlaceholderResolver() {
            ...
            public String resolvePlaceholder(String placeholderName) {
                Field field = ReflectionUtils.findField(ReloadingPropertyPlaceholderConfigurer.class,
                    SYSTEM_PROPERTIES_MODE_FIELD);
                int systemPropertiesMode = SYSTEM_PROPERTIES_MODE_FALLBACK;
                if (null != field) {
                    ReflectionUtils.makeAccessible(field);
                    Object mode = ReflectionUtils
                        .getField(field, ReloadingPropertyPlaceholderConfigurer.this);
                    if (mode != null) {
                        systemPropertiesMode = (int) mode;
                    }
                }
                return ReloadingPropertyPlaceholderConfigurer.this
                    .resolvePlaceholder(placeholderName, props,
                        systemPropertiesMode);
            }

        };
        return helper.replacePlaceholders(buf.toString(), resolver);
    ...
    protected void processProperties(ConfigurableListableBeanFactory beanFactoryToProcess, Properties props)
        ...
        BeanDefinitionVisitor visitor =
                new PlaceholderResolvingBeanDefinitionVisitor(props);
